...
export const PROJECTS = [
  {
    ...
    coverAlt:    'Luxury villa interior design open living and dining — Shree Vihar, Bhubaneswar by Clay and Bricks',
    images: [
      {
        url: '/projects/luxury-villa-shree-vihar/living-dining-layout.jpg',
        alt: 'Luxury open-plan living and formal dining room interior design with brass accents and wood tray ceiling — Shree Vihar, Bhubaneswar by Clay and Bricks interior designers',
      ...
      },
      {
        ...
        alt: 'Luxury modular kitchen design with sage green cabinetry and Calacatta marble backsplash — villa interior design Bhubaneswar by Clay and Bricks',
      ...
      },
      {
        ...
        alt: 'Bespoke fluted glass and brass partition screen in luxury villa interior — architectural design Bhubaneswar by Clay and Bricks',
      ...
      },
      {
        ...
        alt: 'Formal dining room with Italian marble table and brass display vitrines — luxury interior design Shree Vihar Bhubaneswar by Clay and Bricks',
      ...
      },
      {
        ...
        alt: 'Luxury bathroom vanity with fluted wall cladding and copper washbasin — turnkey interior design Bhubaneswar by Clay and Bricks',
    ...
    images: [
      {
        ...
        alt: '3 BHK luxury living room interior design with fluted wood ceiling and gold partition — Bhubaneswar interior designers Clay and Bricks',
      ...
      },
      {
        ...
        alt: 'Modern dining room with fluted wood slat feature wall and marble table — 3 BHK interior design Bhubaneswar by Clay and Bricks',
      ...
      },
      {
        ...
        alt: 'Contemporary dual-tone modular kitchen design with ivory and oak cabinetry — apartment interior design Bhubaneswar by Clay and Bricks',
      ...
      },
      {
        ...
        alt: 'Custom TV entertainment console and handcrafted teakwood Mandir door in 3 BHK interior — Bhubaneswar interior design by Clay and Bricks',
    ...
    images: [
      {
        ...
        alt: 'Luxury master bedroom interior design with fluted timber media wall and walnut console — villa interior design Bhubaneswar by Clay and Bricks',
      ...
      },
      {
        ...
        alt: 'Bespoke home Mandir temple design with backlit Sanskrit inscription and brass bells — interior design Bhubaneswar Odisha by Clay and Bricks',
      ...
      },
      {
        ...
        alt: 'Home office study room design with floating desk and built-in storage — residential interior design Bhubaneswar by Clay and Bricks',
      ...
      },
      {
        ...
        alt: 'Compact beverage bar and dry kitchenette design with pastel blue modular cabinets — interior design Bhubaneswar Odisha by Clay and Bricks',
  ...
  },
  {
    ...
    coverAlt:    'Laterite stone villa architecture and exterior design — Patia, Bhubaneswar by Clay and Bricks architects',
    images: [
      {
        url: '/projects/laterite-villa.jpg',
        alt: 'Luxury laterite stone villa exterior architecture with double-height courtyard pavilion — Patia, Bhubaneswar by Clay and Bricks architects',
  ...
  },
  {
    ...
    coverAlt:    'Brass and noir luxury modular kitchen design with Calacatta marble island — Sahid Nagar, Bhubaneswar by Clay and Bricks',
    images: [
      {
        url: '/projects/brass-kitchen.jpg',
        alt: 'Luxury modular kitchen with antique brass hardware, charcoal cabinetry, and waterfall Calacatta marble island — interior design Sahid Nagar Bhubaneswar by Clay and Bricks',
  ...
  },
  {
    ...
    coverAlt:    'Luxury master bedroom with terracotta plaster walls — residential interior design Nayapalli Bhubaneswar by Clay and Bricks',
    images: [
      {
        url: '/projects/terracotta-bedroom.jpg',
        alt: 'Luxury master bedroom with hand-troweled terracotta plaster walls inspired by Konark temple — interior design Nayapalli Bhubaneswar by Clay and Bricks',
  ...
  },
  {
    ...
    coverAlt:    'Commercial office interior design with fluted sandstone panels — Janpath, Bhubaneswar by Clay and Bricks',
    images: [
      {
        url: '/projects/stone-office.jpg',
        alt: 'Luxury commercial office interior with fluted sandstone panels and hand-carved stone executive desk — Janpath Bhubaneswar by Clay and Bricks interior designers',
  ...
  },
  {
    ...
    coverAlt:    'Luxury pool villa architecture with infinity pool and forest pavilion — Chandaka, Bhubaneswar by Clay and Bricks architects',
    images: [
      {
        url: '/projects/pool-villa.jpg',
        alt: 'Luxury villa architecture with infinity pool and forest pavilion — turnkey construction and interior design Chandaka Bhubaneswar by Clay and Bricks',
  ...
  },
  {
    ...
    coverAlt:    'Boutique hotel lobby interior design with hand-carved sandstone screens — Puri Road, Bhubaneswar by Clay and Bricks',
    images: [
      {
        url: '/projects/boutique-hotel.jpg',
        alt: 'Luxury boutique hotel mandapa lobby interior with hand-carved sandstone screens and gold leaf ceiling — hospitality interior design Bhubaneswar Odisha by Clay and Bricks',
